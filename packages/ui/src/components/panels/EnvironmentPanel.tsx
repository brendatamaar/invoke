    ...
    <div className="flex flex-col h-full">
      ...
      {!envDraft ? (
        ...
        <EnvEditor
          draft={envDraft}
          onSave={saveDraft}
          onCancel={() => set({ envDraft: undefined })}
        />
      )}
      <ConfirmModal
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="flex items-center gap-0 border-b border-[var(--border)] text-2xs text-[var(--text-3)]">
          ...
          <div className="flex-1 flex items-center min-w-0">
            ...
            <span className="px-1.5 shrink-0 invisible">
              <Eye size={11} />
            </span>
          </div>
        ...
        {(draft.variables ?? []).map((v, i) => (
          <div
            key={i}
            className="flex items-center gap-0 border-b border-[var(--border)] last:border-0 hover:bg-[var(--surface-2)]"
          >
            <input
              type="checkbox"
            ...
            <input
              ...
              placeholder="KEY"
              className="flex-1 bg-transparent border-0 outline-none py-1.5 text-xs font-mono min-w-0"
            />
            ...
            <div className="flex-1 flex items-center min-w-0">
              ...
              <button
                ...
                className="px-1.5 text-[var(--text-3)] shrink-0"
              >
        ...
        <button
          onClick={addVar}
          className="flex items-center gap-1.5 px-3 py-1.5 text-xs text-[var(--text-3)] hover:text-[var(--text-1)] w-full"
        >
