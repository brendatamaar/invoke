...
import type { Collection, Environment, Flow, HistoryEntry, SavedRequest } from "../types";
...
export class EnvironmentStore extends Context.Tag("EnvironmentStore")<
  EnvironmentStore,
  {
    ...
    save: (
      env: Partial<Environment> & Pick<Environment, "name" | "variables">,
    ) => Effect.Effect<Environment, StorageError>;
    delete: (id: string) => Effect.Effect<void, StorageError | NotFoundError>;
  }
>() {}
