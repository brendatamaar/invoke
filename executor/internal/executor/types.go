...
type GrpcStreamOpenResponse = executorpb.GrpcStreamOpenResponse
type GrpcStreamSendRequest = executorpb.GrpcStreamSendRequest
type GrpcStreamSendResponse = executorpb.GrpcStreamSendResponse
type GrpcStreamCloseRequest = executorpb.GrpcStreamCloseRequest
type GrpcStreamCloseResponse = executorpb.GrpcStreamCloseResponse
type GrpcStreamPollRequest = executorpb.GrpcStreamPollRequest
type GrpcStreamPollResponse = executorpb.GrpcStreamPollResponse
